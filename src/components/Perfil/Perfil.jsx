...
export const Perfil = () => {
    ...
    const formHandler = ( e ) =>{
        ...
        e.preventDefault()
        fetch('https://netflix-api-luismi11.vercel.app/contenido/usuarios' , options)
        .then( res => res.json())
    ...
    useEffect( () =>{
    fetch('https://netflix-api-luismi11.vercel.app/contenido/usuarios')
    .then( res => res.json())
    .then( data => setUsers(data.netflixData))
    .catch( err => console.log( err ))
    } , [])
    ...
    const eliminarHandler = (  _id  ) => {
        ...
        fetch(`https://netflix-api-luismi11.vercel.app/contenido/usuarios/id/${_id}` , options)
        .then( res => res.json())
        .then( data => setUsers(data.netflixData))
        .catch( err =>  console.log( err ))
    }
